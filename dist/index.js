...
var nextjsChatEngine = require('nextjs-chat-engine');
...
var DataLoader = function DataLoader(props) {
  ...
  var _useContext = React.useContext(nextjsChatEngine.ChatEngineContext),
  ...
  React.useEffect(function () {
    if (!didMountRef.current) {
      ...
      getSession();
      nextjsChatEngine.getLatestChats(props, 25, function (chats) {
  ...
  function onGetChats(chats) {
    ...
    nextjsChatEngine.getLatestMessages(props, activeChatID, 45, function (id, list) {
      setSendingMessages({});
...
var Socket = function Socket(props) {
    ...
    try {
      ...
      if (eventJSON.action === 'pong') {
        ...
        if (message.sender_username !== props.userName && isBottomVisible) {
          nextjsChatEngine.readMessage(conn, activeChat, message.id, function (chat) {
  ...
  function onConnect(conn) {
    ...
    nextjsChatEngine.getLatestChats(conn, 25, function (chats) {
      return setChats(_.mapKeys(chats, 'id'));
    });
    if (Date.now() > reconnect || conn.renderChatFeed) {
      nextjsChatEngine.getLatestMessages(conn, activeChat, 45, function (id, list) {
        setSendingMessages({});
...
var SocketChild = function SocketChild(props) {
  ...
  function onConnect(conn) {
    ...
    nextjsChatEngine.getChat(conn, props.chatID, function (chat) {
      return onGetChat(chat);
    });
    if (Date.now() > reconnect$1) {
      setSendingMessages({});
      nextjsChatEngine.getLatestMessages(conn, props.chatID, 45, function (id, list) {
        setMessages(_extends({}, messages, _.mapKeys(list, 'id')));
      });
    }
    props.onConnect && props.onConnect(conn);
...
var NewChatForm = function NewChatForm(props) {
  ...
  }, /*#__PURE__*/React__default.createElement(nextjsChatEngine.TextInput, {
    autoFocus: true,
    label: "Chat Title",
    value: value,
  ...
  }, /*#__PURE__*/React__default.createElement(nextjsChatEngine.Button, {
    icon: "plus",
...
var ChatList = function ChatList(props) {
  ...
  React.useEffect(function () {
    if (!didMountRef.current) {
      didMountRef.current = true;
      nextjsChatEngine.getLatestChats(props, interval, function (chats) {
        onGetChats(chats);
  ...
  React.useEffect(function () {
    ...
    if (chatList.length > 0) {
      ...
      nextjsChatEngine.getChatsBefore(props, before, interval, function (chats) {
        return onGetChats(chats);
      });
    }
  }, [loadChats]);
...
var PersonRow = function PersonRow(props) {
  ...
  function onRemovePerson() {
    nextjsChatEngine.removePerson(props.conn, props.chat.id, props.person.username);
  }
  ...
  }, /*#__PURE__*/React__default.createElement(nextjsChatEngine.Avatar, {
...
var PersonOption = function PersonOption(props) {
  ...
  }, /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(nextjsChatEngine.Avatar, {
    username: username,
    avatar: avatar
  })), /*#__PURE__*/React__default.createElement("div", {
    style: {
...
var PersonForm = function PersonForm(props) {
  ...
  function invitePerson(name) {
    nextjsChatEngine.addPerson(props.conn, props.chat.id, name, function () {
      setState(_extends({}, state, {
        value: ''
      }));
      getOthers();
  ...
  function getOthers() {
    nextjsChatEngine.getOtherPeople(props.conn, props.chat.id, function (id, others) {
  ...
  }, /*#__PURE__*/React__default.createElement(nextjsChatEngine.AutoCompleteInput, {
    style: {
      width: '100%'
    },
...
var OptionsSettings = function OptionsSettings() {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    onClick: function onClick() {
      return nextjsChatEngine.deleteChat(conn, chat.id, function (data) {});
    },
    style: {
      width: '100%',
      marginBottom: '12px'
...
var NewMessageForm = function NewMessageForm(props) {
  ...
  function handleSubmit(event) {
    event.preventDefault();
    nextjsChatEngine.editChat(props.conn, props.chat.id, {
      title: state.value
    }, function (data) {});
  }
  React.useEffect(function () {
...
var TheirMessage = function TheirMessage(props) {
  ...
  function renderReads() {
    ...
    return chat.people.map(function (person, index) {
      if (message.id === person.last_read) {
        return /*#__PURE__*/React__default.createElement(nextjsChatEngine.Dot, {
          key: "read_" + index,
  ...
  }, (!nextMessage || nextMessage.sender_username !== message.sender_username) && /*#__PURE__*/React__default.createElement(nextjsChatEngine.Avatar, {
    show_online: false,
...
var NewMessageForm$1 = function NewMessageForm() {
  ...
  function handleChange(value) {
    ...
    if (trigger === 1) {
      conn && nextjsChatEngine.isTyping(conn, activeChat);
    }
  }
  function handleSubmit() {
    ...
    if (text.length > 0 || attachments.length > 0) {
      nextjsChatEngine.sendMessage(conn, activeChat, data, function () {});
    }
    setValue('');
    setAttachments([]);
...
var ChatFeed = function ChatFeed(props) {
  ...
  function onGetMessages(chatId, messages, scrollDownTo) {
    ...
    if (messages.length > 0) {
      ...
      if (props.userName && props.userName !== message.sender_username) {
        nextjsChatEngine.readMessage(conn, chatId, message.id, function (chat) {
  ...
  function loadMessages(loadMoreMessages) {
    if (loadMoreMessages) {
      ...
      nextjsChatEngine.getLatestMessages(conn, activeChat, count, function (chatId, messages) {
      ...
      nextjsChatEngine.getLatestMessages(conn, props.activeChat, count, function (chatId, messages) {
        return onGetMessages(chatId, messages, "ce-feed-container");
      });
    }
  }
  ...
  React.useEffect(function () {
    if (isBottomVisible && !_$1.isEmpty(messages)) {
      ...
      if (getMyLastMessage(conn.userName, chat) && getMyLastMessage(conn.userName, chat) !== chat.last_message.id) {
        nextjsChatEngine.readMessage(conn, currentChat, chat.last_message.id, function (chat) {
          return onReadMessage(chat);
        });
      }
    }
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    onChatClick: function onChatClick(chatID) {
      if (props.renderChatFeed) {
        nextjsChatEngine.getLatestMessages(props, chatID, 45, function (id, list) {
